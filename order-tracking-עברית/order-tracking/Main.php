<?php
/*
Plugin Name: Status Tracking Plugin
Plugin URI: http://www.EtoileWebDesign.com/order-tracking/
Description: A plugin that lets visitors track statuses by putting in a tracking number, as well as send out update e-mails
