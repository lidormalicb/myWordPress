...
function EWD_OTP_Return_Results($TrackingNumber, $Fields = array(), $Email = '', $notes_submit = '') {
	...
	$Order_Name_Label = get_option("EWD_OTP_Order_Name_Label");
		if ($Order_Name_Label == "") {$Order_Name_Label = __("Order Name", "EWD_OTP");}
	...
	$Order_Notes_Label = get_option("EWD_OTP_Order_Notes_Label");
		if ($Order_Notes_Label == "") {$Order_Notes_Label = __("Order Notes", "EWD_OTP");}
	...
	$Order_Map_Label = get_option("EWD_OTP_Current_Location_Label");
	if($Order_Map_Label == ""){$Order_Map_Label = __("Current Location", "EWD_OTP");}
	...
	$Order_Location_Label = get_option("EWD_OTP_Order_Location_Label");
		if ($Order_Location_Label == "") {$Order_Location_Label = __("Order Location", "EWD_OTP");}
	...
	if($Update_Status_Button_Label == ""){$Update_Status_Button_Label = __("Update Status", "EWD_OTP");}
	$Add_Note_Button_Label = get_option("EWD_OTP_Add_Note_Button_Label");
	if($Add_Note_Button_Label == ""){$Add_Note_Button_Label = __("Add Note", "EWD_OTP");}
	...
	if ($wpdb->num_rows == 0) {
		...
		if (in_array("Customer_Notes", $Order_Information)) {
			...
			$ReturnString .= "<input class='ewd-otp-submit' type='submit' name='Notes_Submit' value='" . $Add_Note_Button_Label . "' />";
			$ReturnString .= "</form>";
			$ReturnString .= "</div>";
		}
	}
