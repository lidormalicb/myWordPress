...
function Add_EWD_OTP_Orders_From_Spreadsheet($Excel_File_Name) {
	...
	$Allowed_Fields = array ("Name" => "Order_Name", "Number" => "Order_Number", "Order Status" => "Order_Status", "Location" => "Order_Location", "Display" => "Order_Display", "Notes Public" => "Order_Notes_Public", "Notes Private" => "Order_Notes_Private", "Email" => "Order_Email", "Show in Admin Table" => "Order_Display", "Sales Rep ID" => "Sales_Rep_ID");
...
function Update_EWD_OTP_Options() {
	...
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['current_location_label'])) {update_option("EWD_OTP_Current_Location_Label", $_POST['current_location_label']);}
	...
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['update_status_button_label'])) {update_option("EWD_OTP_Update_Status_Button_Label", $_POST['update_status_button_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['add_note_button_label'])) {update_option("EWD_OTP_Add_Note_Button_Label", $_POST['add_note_button_label']);}
	...
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['customer_order_form_order_name_label'])) {update_option("EWD_OTP_Customer_Order_Form_Order_Name_Label", $_POST['customer_order_form_order_name_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['customer_order_form_order_email_label'])) {update_option("EWD_OTP_Customer_Order_Form_Order_Email_Label", $_POST['customer_order_form_order_email_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['customer_order_form_customer_notes_label'])) {update_option("EWD_OTP_Customer_Order_Form_Customer_Notes_Label", $_POST['customer_order_form_customer_notes_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['customer_order_form_send_order_label'])) {update_option("EWD_OTP_Customer_Order_Form_Send_Order_Label", $_POST['customer_order_form_send_order_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['customer_order_form_success_label'])) {update_option("EWD_OTP_Customer_Order_Form_Success_Label", $_POST['customer_order_form_success_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['customer_tracking_track_your_order_label'])) {update_option("EWD_OTP_Customer_Tracking_Track_Your_Order_Label", $_POST['customer_tracking_track_your_order_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['customer_tracking_enter_order_label'])) {update_option("EWD_OTP_Customer_Tracking_Enter_Order_Label", $_POST['customer_tracking_enter_order_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['customer_tracking_customer_number_label'])) {update_option("EWD_OTP_Customer_Tracking_Customer_Number_Label", $_POST['customer_tracking_customer_number_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['customer_tracking_customer_number_placeholder_label'])) {update_option("EWD_OTP_Customer_Tracking_Customer_Number_Placeholder_Label", $_POST['customer_tracking_customer_number_placeholder_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['customer_tracking_customer_email_label'])) {update_option("EWD_OTP_Customer_Tracking_Customer_Email_Label", $_POST['customer_tracking_customer_email_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['customer_tracking_customer_email_placeholder_label'])) {update_option("EWD_OTP_Customer_Tracking_Customer_Email_Placeholder_Label", $_POST['customer_tracking_customer_email_placeholder_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['customer_tracking_track_button_label'])) {update_option("EWD_OTP_Customer_Tracking_Track_Button_Label", $_POST['customer_tracking_track_button_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['salesrep_tracking_track_your_order_label'])) {update_option("EWD_OTP_SalesRep_Tracking_Track_Your_Order_Label", $_POST['salesrep_tracking_track_your_order_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['salesrep_tracking_enter_order_label'])) {update_option("EWD_OTP_SalesRep_Tracking_Enter_Order_Label", $_POST['salesrep_tracking_enter_order_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['salesrep_tracking_salesrep_number_label'])) {update_option("EWD_OTP_SalesRep_Tracking_SalesRep_Number_Label", $_POST['salesrep_tracking_salesrep_number_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['salesrep_tracking_salesrep_number_placeholder_label'])) {update_option("EWD_OTP_SalesRep_Tracking_SalesRep_Number_Placeholder_Label", $_POST['salesrep_tracking_salesrep_number_placeholder_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['salesrep_tracking_salesrep_email_label'])) {update_option("EWD_OTP_SalesRep_Tracking_SalesRep_Email_Label", $_POST['salesrep_tracking_salesrep_email_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['salesrep_tracking_salesrep_email_placeholder_label'])) {update_option("EWD_OTP_SalesRep_Tracking_SalesRep_Email_Placeholder_Label", $_POST['salesrep_tracking_salesrep_email_placeholder_label']);}
	if ($EWD_OTP_Full_Version == "Yes" and isset($_POST['salesrep_tracking_track_button_label'])) {update_option("EWD_OTP_SalesRep_Tracking_Track_Button_Label", $_POST['salesrep_tracking_track_button_label']);}
