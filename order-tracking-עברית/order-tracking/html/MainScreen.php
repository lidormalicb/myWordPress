<div class="EWD_OTP_Menu">
	...
	<a id="Locations_Menu" class="MenuTab nav-tab <?php if ($Display_Page == 'Locations') {echo 'nav-tab-active';}?>" onclick="ShowTab('Locations');"><?php _e("Locations", "EWD_OTP"); ?></a>
	...
	<a id="Statistics_Menu" class="MenuTab nav-tab <?php if ($Display_Page == 'Statistics') {echo 'nav-tab-active';}?>" onclick="ShowTab('Statistics');"><?php _e("Statistics", "EWD_OTP"); ?></a>
