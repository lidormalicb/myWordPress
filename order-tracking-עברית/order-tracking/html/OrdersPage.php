...
<?php if ($Allow_Order_Payments == "Yes") { ?>
	<div class="form-field">
		<label for="Order_Payment_Price"><?php _e("Order Payment Price", 'EWD_OTP') ?></label>
		<input type='text' name="Order_Payment_Price" id="Order_Payment_Price" />
		<p><?php _e("The amount that should be paid via PayPal for this order.", 'EWD_OTP') ?></p>
	</div>
	<div>
		<label for="Order_Payment_Completed"><?php _e("Payment Completed?", 'EWD_OTP') ?></label>
		...
		<p><?php _e("Has the payment for this order been made? This field should automatically update when payment is made for this order.", 'EWD_OTP') ?></p>
</div>
	<div class="form-field">
		<label for="Order_PayPal_Receipt_Number"><?php _e("PayPal Transaction ID", 'EWD_OTP') ?></label>
		<input type='text' name="Order_PayPal_Receipt_Number" id="Order_PayPal_Receipt_Number" />
		<p><?php _e("The transaction ID generated by PayPal for this order once th payment is made (leave blank until payment is made).", 'EWD_OTP') ?></p>
	</div>
<?php } ?>
<div>
