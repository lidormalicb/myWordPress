...
<div class="Info-Div">
		...
		<div class="upcp-full-version-explanation">
				<?php _e("The full version of Status Tracking is required to use statistics.", "UPCP");?><a href="http://www.etoilewebdesign.com/order-tracking/"><?php _e(" Please upgrade to unlock this page!", 'EWD_OTP'); ?></a>
		</div>
</div>
<?php } ?>
