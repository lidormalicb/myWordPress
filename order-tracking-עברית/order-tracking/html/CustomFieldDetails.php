		...
		<div class="form-wrap TagDetail">
			...
			<div class="form-field">
				...
				<select name="Field_Function" id="Field_Function">
					<option value='Orders' <?php if ($Field->Field_Function == "Orders") {echo "selected=selected";} ?> ><?php _e("Orders", 'EWD_OTP') ?></option>
					<option value='Customers' <?php if ($Field->Field_Function == "Customers") {echo "selected=selected";} ?> ><?php _e("Customers", 'EWD_OTP') ?></option>
					<option value='Sales_Reps' <?php if ($Field->Field_Function == "Sales_Reps") {echo "selected=selected";} ?> ><?php _e("Sales Reps", 'EWD_OTP') ?></option>
				</select>
