<?php
	...
	$Current_Location_Label = get_option("EWD_OTP_Current_Location_Label");
	...
	$Update_Status_Button_Label = get_option("EWD_OTP_Update_Status_Button_Label");
	$Add_Note_Button_Label = get_option("EWD_OTP_Add_Note_Button_Label");
	$Customer_Order_Form_Order_Name_Label = get_option("EWD_OTP_Customer_Order_Form_Order_Name_Label");
	$Customer_Order_Form_Order_Email_Label = get_option("EWD_OTP_Customer_Order_Form_Order_Email_Label");
	$Customer_Order_Form_Customer_Notes_Label = get_option("EWD_OTP_Customer_Order_Form_Customer_Notes_Label");
	$Customer_Order_Form_Send_Order_Label = get_option("EWD_OTP_Customer_Order_Form_Send_Order_Label");
	$Customer_Order_Form_Success_Label = get_option("EWD_OTP_Customer_Order_Form_Success_Label");
	...
	$SalesRep_Tracking_Track_Your_Order_Label = get_option("EWD_OTP_SalesRep_Tracking_Track_Your_Order_Label");
	$SalesRep_Tracking_Enter_Order_Label = get_option("EWD_OTP_SalesRep_Tracking_Enter_Order_Label");
	$SalesRep_Tracking_SalesRep_Number_Label = get_option("EWD_OTP_SalesRep_Tracking_SalesRep_Number_Label");
	$SalesRep_Tracking_SalesRep_Number_Placeholder_Label = get_option("EWD_OTP_SalesRep_Tracking_SalesRep_Number_Placeholder_Label");
	$SalesRep_Tracking_SalesRep_Email_Label = get_option("EWD_OTP_SalesRep_Tracking_SalesRep_Email_Label");
	$SalesRep_Tracking_SalesRep_Email_Placeholder_Label = get_option("EWD_OTP_SalesRep_Tracking_SalesRep_Email_Placeholder_Label");
	$SalesRep_Tracking_Track_Button_Label = get_option("EWD_OTP_SalesRep_Tracking_Track_Button_Label");
...
<div id='Labelling' class='otp-option-set otp-hidden'>
	...
	<div id='labelling-view-options' class="otp-options-div otp-options-flex">
		...
		<div class='otp-option otp-field-input'>
			<?php _e("Order Number placeholder", 'OTP')?>
			<fieldset>
		...
		<div class='otp-option otp-field-input'>
		<?php _e("Order Email Address placeholder", 'OTP')?>
			<fieldset>
		...
		<div class='otp-option otp-field-input'>
			<?php _e("Current Location", 'OTP')?>
			<fieldset>
			<input type='text' name='current_location_label' value='<?php echo $Current_Location_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input'>
		...
		<div class='otp-option otp-field-input'>
			<?php _e("Update Status (button)", 'OTP')?>
			<fieldset>
			<input type='text' name='update_status_button_label' value='<?php echo $Update_Status_Button_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input'>
			<?php _e("Add Note (button)", 'OTP')?>
			<fieldset>
			<input type='text' name='add_note_button_label' value='<?php echo $Add_Note_Button_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class="otp-styling-header">Customer Order Form</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Order Name", 'OTP')?>
			<fieldset>
			<input type='text' name='customer_order_form_order_name_label' value='<?php echo $Customer_Order_Form_Order_Name_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Order E-mail Address", 'OTP')?>
			<fieldset>
			<input type='text' name='customer_order_form_order_email_label' value='<?php echo $Customer_Order_Form_Order_Email_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Customer Notes", 'OTP')?>
			<fieldset>
			<input type='text' name='customer_order_form_customer_notes_label' value='<?php echo $Customer_Order_Form_Customer_Notes_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Send Order (button)", 'OTP')?>
			<fieldset>
			<input type='text' name='customer_order_form_send_order_label' value='<?php echo $Customer_Order_Form_Send_Order_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Success Message", 'OTP')?>
			<fieldset>
			<input type='text' name='customer_order_form_success_label' value='<?php echo $Customer_Order_Form_Success_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class="otp-styling-header">Customer Tracking Form</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Track Your Orders", 'OTP')?>
			<fieldset>
			<input type='text' name='customer_tracking_track_your_order_label' value='<?php echo $Customer_Tracking_Track_Your_Order_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Description text", 'OTP')?>
			<fieldset>
			<input type='text' name='customer_tracking_enter_order_label' value='<?php echo $Customer_Tracking_Enter_Order_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Customer Number", 'OTP')?>
			<fieldset>
			<input type='text' name='customer_tracking_customer_number_label' value='<?php echo $Customer_Tracking_Customer_Number_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Customer Number placeholder", 'OTP')?>
			<fieldset>
			<input type='text' name='customer_tracking_customer_number_placeholder_label' value='<?php echo $Customer_Tracking_Customer_Number_Placeholder_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Customer Email", 'OTP')?>
			<fieldset>
			<input type='text' name='customer_tracking_customer_email_label' value='<?php echo $Customer_Tracking_Customer_Email_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Customer Email placeholder", 'OTP')?>
			<fieldset>
			<input type='text' name='customer_tracking_customer_email_placeholder_label' value='<?php echo $Customer_Tracking_Customer_Email_Placeholder_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Track (button)", 'OTP')?>
			<fieldset>
			<input type='text' name='customer_tracking_track_button_label' value='<?php echo $Customer_Tracking_Track_Button_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class="otp-styling-header">Sales Rep Tracking Form</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Track Your Orders", 'OTP')?>
			<fieldset>
			<input type='text' name='salesrep_tracking_track_your_order_label' value='<?php echo $SalesRep_Tracking_Track_Your_Order_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Description text", 'OTP')?>
			<fieldset>
			<input type='text' name='salesrep_tracking_enter_order_label' value='<?php echo $SalesRep_Tracking_Enter_Order_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Sales Rep Number", 'OTP')?>
			<fieldset>
			<input type='text' name='salesrep_tracking_salesrep_number_label' value='<?php echo $SalesRep_Tracking_SalesRep_Number_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Sales Rep Number placeholder", 'OTP')?>
			<fieldset>
			<input type='text' name='salesrep_tracking_salesrep_number_placeholder_label' value='<?php echo $SalesRep_Tracking_SalesRep_Number_Placeholder_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Sales Rep Email", 'OTP')?>
			<fieldset>
			<input type='text' name='salesrep_tracking_salesrep_email_label' value='<?php echo $SalesRep_Tracking_SalesRep_Email_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Sales Rep Email placeholder", 'OTP')?>
			<fieldset>
			<input type='text' name='salesrep_tracking_salesrep_email_placeholder_label' value='<?php echo $SalesRep_Tracking_SalesRep_Email_Placeholder_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
		<div class='otp-option otp-field-input '>
			<?php _e("Track (button)", 'OTP')?>
			<fieldset>
			<input type='text' name='salesrep_tracking_track_button_label' value='<?php echo $SalesRep_Tracking_Track_Button_Label; ?>' <?php if ($EWD_OTP_Full_Version != "Yes") {echo "disabled";} ?>/>
			</fieldset>
		</div>
	</div>
</div>
