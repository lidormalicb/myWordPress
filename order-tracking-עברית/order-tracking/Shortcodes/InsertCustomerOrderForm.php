...
function Insert_Customer_Order_Form($atts) {
	...
	if($Customer_Order_Form_Order_Name_Label == ""){$Customer_Order_Form_Order_Name_Label = __('Order Name', 'EWD_OTP');}
	$Customer_Order_Form_Order_Email_Label = get_option("EWD_OTP_Customer_Order_Form_Order_Email_Label");
	if($Customer_Order_Form_Order_Email_Label == ""){$Customer_Order_Form_Order_Email_Label = __('Order E-mail Address', 'EWD_OTP');}
	$Customer_Order_Form_Customer_Notes_Label = get_option("EWD_OTP_Customer_Order_Form_Customer_Notes_Label");
	if($Customer_Order_Form_Customer_Notes_Label == ""){$Customer_Order_Form_Customer_Notes_Label = __('Customer Notes', 'EWD_OTP');}
	$Customer_Order_Form_Send_Order_Label = get_option("EWD_OTP_Customer_Order_Form_Send_Order_Label");
	if($Customer_Order_Form_Send_Order_Label == ""){$Customer_Order_Form_Send_Order_Label = __('Send Order', 'EWD_OTP');}
	$Customer_Order_Form_Success_Label = get_option("EWD_OTP_Customer_Order_Form_Success_Label");
	if($Customer_Order_Form_Success_Label == ""){$Customer_Order_Form_Success_Label = __('Thank you. Your order number is: ', 'EWD_OTP');}
	...
	extract( shortcode_atts( array(
		 		'order_status' => '',
		 		'order_location' => '',
		 		'success_message' => $Customer_Order_Form_Success_Label,
		 		'customer_form_title' => __('Create an Order', 'EWD_OTP'),
				'customer_name_field_text' => $Customer_Order_Form_Order_Name_Label,
				'customer_email_field_text' => $Customer_Order_Form_Order_Email_Label,
				'customer_notes_field_text' => $Customer_Order_Form_Customer_Notes_Label,
				'customer_instructions' => __('Please fill out the form below to create an order.', 'EWD_OTP'),
				'submit_text' => $Customer_Order_Form_Send_Order_Label),
		$atts
		)
	);
