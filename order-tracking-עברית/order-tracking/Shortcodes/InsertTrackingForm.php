...
function Insert_Tracking_Form($atts) {
	...
	if ($Tracking_Ordernumber_Placeholder_Label == "") {$Tracking_Ordernumber_Placeholder_Label = __("Order Number", "EWD_OTP");}
	$Tracking_Email_Placeholder_Label = get_option("EWD_OTP_Tracking_Email_Placeholder_Label");
	if ($Tracking_Email_Placeholder_Label == "") {$Tracking_Email_Placeholder_Label = __("Order E-mail Address", "EWD_OTP");}
